...
function PlatformButton({ platform, icon, index }: PlatformButtonProps) {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.98 }}
      className="group relative flex flex-col items-center justify-center gap-4 p-10 bg-gradient-to-br from-zinc-900/80 to-zinc-900/50 backdrop-blur-sm border-2 border-zinc-800 rounded-2xl hover:border-cyan-500/50 transition-all duration-300 w-full sm:w-[16rem]"
    >
      {/* Glow effect */}
      ...
      <div className="relative flex flex-col items-center justify-center">
        {/* Icon */}
        <div className="w-16 h-16 mb-4 rounded-2xl bg-gradient-to-br from-cyan-500/30 to-purple-600/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 mx-auto">
        ...
        {/* Platform name */}
        <h3 className="text-2xl font-bold mb-2 text-center group-hover:text-cyan-300 transition-colors w-full">
          {platform}
        </h3>

        {/* Download text */}
        <div className="flex items-center justify-center gap-2 text-gray-400 group-hover:text-white transition-colors w-full">
...
export default function DownloadCTA() {
  ...
  return (
    <section id="download" className="relative py-24 sm:py-32 lg:py-40 px-6 overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto mb-4 leading-relaxed text-center" style={{ marginBottom: '40px' }}>
